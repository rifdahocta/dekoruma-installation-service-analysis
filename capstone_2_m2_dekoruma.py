...
Distribusi transaksi menunjukkan adanya konsentrasi pada tiga kategori utama (Lemari (14,74%), Dekorasi (14,59%), dan Sofa (14,44%)), sedangkan kategori lainnya memiliki proporsi yang lebih rendah, sedangkan Bed (5,19%) memiliki proporsi transaksi paling kecil. Tidak terdapat satu kategori yang mendominasi sebagian besar transaksi, tetapi Permintaan pelanggan lebih banyak terkonsentrasi pada produk penyimpanan (Lemari) dan furnitur ruang tamu (Sofa) serta dekorasi rumah.
"""
...
install_result["Percentage"] = (
    ...
    install_result["Count"].sum() * 100).round(2)
...
"""### 4.1	Installation Performance by Product Category
...
"""### 4.2	Installation Performance by Sales Channel
...
"""### 4.3	Installation Performance by Store
